...
## set up for 2x2 plot (by rows)
par(mfrow = c(2,2))

## build plot 1
plot(powerdata$datetime, powerdata$Global_active_power, ylab = "Global Active Power", xlab = "", type = "n")
lines(powerdata$datetime, powerdata$Global_active_power)

## build plot 2
plot(powerdata$datetime, powerdata$Voltage, ylab = "Voltage", xlab = "datetime", type = "n")
...
legend("topright", legend =  c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), fill = c("black", "red", "blue"), border = c("black","red","blue"))

## build plot 4
plot(powerdata$datetime, powerdata$Global_reactive_power, ylab = "Global Reactive Power", xlab = "datetime", pch = ".")
